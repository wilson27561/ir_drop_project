...
const string ADD_STRIPE_FILE = "add_stripe_PD9_6t49_b19_routing_88_9_stripe.tcl";
...
//   //將它分成區段
        ...
        //              vdd_stripe_vector[i].resist_line_map.insert(pair<string,ResistLine>(x_location,resist_line));
                    
        //              if(stof(vdd_stripe_vector[i].total_resist) == 0){
        //                  vdd_stripe_vector[i].total_resist_line = resist_line;
        //                  vdd_stripe_vector[i].total_resist = resist_line.total_resistance;
        //              }else if(stof(vdd_stripe_vector[i].total_resist) > stof(resist_line.total_resistance)){
        //                  vdd_stripe_vector[i].total_resist_line = resist_line;
        //                  vdd_stripe_vector[i].total_resist = resist_line.total_resistance;
        //              }
        //              break;;
