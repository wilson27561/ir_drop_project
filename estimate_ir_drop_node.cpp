...
// int main()
{
    ...
    if (config)
    {
        while (getline(config, config_content))
        {
            ...
            if (config_content_array[0] == "RESISTANCE_REPORT")
            {
                RESISTANCE_REPORT = config_content_array[2];
            }
    ...
    getResistanceReport(RESISTANCE_REPORT, &cell_pin_resist_map);
